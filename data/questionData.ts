...
const questionInfo: QuestionInfo[] = [
...

  {
    id: 2,
    title: "노트북이 꼭 필요하나요?",
    desc: "동아리에서 쓰는 용도 외에도 과제를 수행하기 위해 노트북이 필요한 경우가 많습니다. 하지만, 노트북 소지가 필수는 아니므로 신중하게 고르시는게 좋겠죠?",
  },
  {
    id: 3,
    title: "언제 진행되나요?",
  ...
  },
  {
    ...
    desc: "혹시 추가적으로 궁금한 사항이 있다면 시연회 인스타그램 DM으로 연락해주세요!"
  },
  {
    id: 5,
  ...
  },
  {
    id: 6,
    title: "포트폴리오를 받나요?",
    desc: "동아리마다 상이하지만 내가 가고싶은 동아리중 포트폴리오를 받는 동아리가 한곳이라도 존재한다면 면접 지원폼에 포트폴리오를 기재해주세요!",
  },
  {
    id: 7,
    title: "동아리에서 전부 탈락하면 어떻게 되나요?",
    desc: "동아리에서 전부 탈락하면 인원이 다 모집되지 않은 동아리중 2차면접을 응시해서 들어갈 수 있어요!",
  },
  {
    id: 8,
    title: "시연회가 도대체 뭔가요?",
