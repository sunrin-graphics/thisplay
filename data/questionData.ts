...
const questionInfo: QuestionInfo[] = [
  ...
  },
  {
    id: 2,
    title: "언제 진행되나요?",
    desc: "3월 2일부터 온라인으로, 3월 8일 7교시에 오프라인 행사가 진행될 예정이에요.",
  },
  {
    id: 3,
    title: "동아리가 고민될 때는 어쩌죠?",
    desc: "시연회 사이트의 동아리별 페이지를 통해 여러분의 적성에 맞는 동아리를 찾아보세요!",
  },
  {
    id: 4,
  ...
  },
  {
    ...
    desc: "1차 모집 이후 인원이 전부 충원되지 않은 동아리에서 2차 면접을 진행하면 이에 응시해서 들어갈 수 있어요.",
  },
  {
    id: 7,
